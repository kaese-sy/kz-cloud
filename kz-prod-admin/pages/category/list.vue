				...
				form1:{
					...
					props: {
						...
						columns:[
							...
							{ key:"is_home_show", title:"是否首页显示", type: "switch", activeValue: true, inactiveValue: false },
							{ key:"sort", title:"显示顺序", type:"number", limit:1 },
						],
						// 表单验证规则
						rules:{
							name: [
								// 必填
								{ required: true, message: '分类名称为必填字段', trigger: ['blur','change'] },
								// 长度在 2-20 个字
								{ min: 2, max: 20, message: '分类名称长度在 2 到 20 之间', trigger: 'blur' }
							],
						},
